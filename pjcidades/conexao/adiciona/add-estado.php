<?php 
	...
	if (count($exibe) >= 1) {
		...
		$sql = "INSERT INTO `estado`(`id_pais`, `id_regiao`, `nome`, `imagem_inicio`, `nome_oficial`, `gentilico`, `populacao`, `localizacao`,
        `capital`, `area`, `pib`, `idh`, `text_historia`, `imagem_historia`, `text_bandeira`, `imagem_bandeira`, `text_economia`, `imagem_economia`, 
        `text_cultura`, `imagem_cultura`, `text_clima`, `text_vegetacao`, `text_relevo`) VALUES ('$pais', '$regiao','$nome','$img_inicio','$nome_oficial', '$gentilico', 
