	...
	<main>
		<section id="inicio">
			<div class="container-inicio">
				<div class="text-inicio">
					<h1><?php echo $exibe_regiao[0]['nome'];?></h1>
				</div>
			</div>

			<img src="<?php echo $exibe_regiao[0]['imagem_inicio'];?>" class="img-inicio">
		</section>
			...
			<div class="text-regioes">
				<div class="numeros">
					...
					<div class="informacoes">
						<p>Localização: <?php echo $exibe_regiao[0]['localizacao'];?></p>
						<p>Número de Habitantes: <?php echo $exibe_regiao[0]['populacao'];?></p>
						<p>Área Territorial: <?php echo $exibe_regiao[0]['area'];?></p>
						<p>PIB: <?php echo $exibe_regiao[0]['pib'];?></p>
						<p>IDH: <?php echo $exibe_regiao[0]['idh'];?></p>
					</div>
			</div>
		</section>
		...
		<section id="historia">
			<div class="img-historia">
				<img src="<?php echo $exibe_regiao[0]['imagem_historia'];?>">
			</div>
			<div class="text-historia">
				<h2>História</h2>
				<p><?php echo $exibe_regiao[0]['text_historia'];?></p>
			</div>
		</section>
		...
		<section id="geografia">
			<div class="container-geografia">
				...
				<div class="cards-geografia">
					...
					<div>
						<h3>Relevo</h3>
						<p><?php echo $exibe_regiao[0]['text_relevo'];?></p>
					</div>
				</div>
			</div>
		...
		<section id="economia">
			<div class="img-economia">
				<img src="<?php echo $exibe_regiao[0]['imagem_economia'];?>">
			</div>

			<div class="text-economia">
					<h2>Econômia</h2>
					<p><?php echo $exibe_regiao[0]['text_economia'];?>.</p>
			</div>
		</section>
		...
		<section id="cultura">
			<div class="text-cultura">
					<h2>Cultura</h2>
					<p><?php echo $exibe_regiao[0]['text_cultura'];?></p>
			</div>
			<div class="img-cultura">
				<img src="<?php echo $exibe_regiao[0]['imagem_cultura'];?>">
			</div>
		</section>
