			...
			<div class="text-regioes">
				<div class="numeros">
					...
					<div class="informacoes">
						...
						<p>Localização: <?php echo $exibe_estado[0]['localizacao'];?></p>
						<p>Capital: <?php echo $exibe_estado[0]['capital'];?></p>
						<p>Número de Habitantes: <?php echo $exibe_estado[0]['populacao'];?></p>
						<p>Área Territorial: <?php echo $exibe_estado[0]['area'];?></p>
