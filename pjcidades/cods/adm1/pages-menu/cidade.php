			...
			<div class="row">
                ...
                <?php  
                    if ($pesquisa != "false") {
                        ...
                        $consulta_pesquisa = mysqli_query($cn, "SELECT * FROM `cidade` WHERE nome = '$pesquisa'");
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="btns-cards">
                                            <button>
                                                <a href="../forms-update/up-cidade.php?id=<?php echo$exibe_pesquisa[$i]['id'];?>">Alterar</a>
                                            </button>
                                            <button>
                                                <a href="../../../conexao/deleta/del-cidade.php?id=<?php echo$exibe_pesquisa[$i]['id'];?>">Deletar</a>
                                            </button>
                                        </div>
                                    </div>
                                </div>
