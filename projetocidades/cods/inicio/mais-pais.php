...
<body>
	...
	<section id="cards-regioes" data-id="5">
		...
		<div class="container-regioes">
			<a href="#" class="card-regioes active" id="1">
				<div >
					<h3>Sul</h3>
				</div>
			</a>

			<a href="#" class="card-regioes active" id="2">
				<div >
					<h3>Sudeste</h3>
				</div>
			</a>

			<a href="#" class="card-regioes active" id="3">
				<div >
					<h3>Centr-Oeste</h3>
				</div>
			</a>

			<a href="#" class="card-regioes active" id="4">
				<div >
					<h3>Norte</h3>
				</div>
			</a>

			<a href="#" class="card-regioes" id="5">
				<div >
					<h3>Nordeste</h3>
				</div>
			</a>
	...
	<script>
		...
		function mostrarAnterior(){
			const cards = el.querySelectorAll("#cards-regioes a")
			const cardsActives = document.querySelectorAll(".active")
			let primeiro = false;
			let ultimo = false;
			let count = 0;
			...
			cards.forEach((card, index, arr) => {
				if(!primeiro && card.classList.contains('active')) {
					primeiro = true;
					if (arr[index - 1]) {
				...
				if(count >= cardsActives.length && !ultimo) {
					if(cardsActives.length >= CARD_ATIVOS) {
